function psychoMelanopsinAnalysisLocalHook
% psychoMelanopsinAnalysisLocalHook
%
...
%% Say hello
fprintf('* Running psychoMelanopsinAnalysisLocalHook...');

%% Set preferences

% Find the project directory, add it to the path, save this as a
%  pref, and then make this the current directory
projectDir = fullfile(tbLocateProject('psychoMelanopsinAnalysis'));
addpath(genpath(projectDir));
setpref('psychoMelanopsinAnalysis', 'projectDir', projectDir);
